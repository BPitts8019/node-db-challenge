exports.seed = async knex => {
   await knex("tasks").insert([
      {name: "Start It", description: "It's in the name!!", project_id: 1},
      ...
      {name: "Start It", description: "It's in the name!!", project_id: 2},
      {name: "Do It", description: "Do the thing", notes: "Do it quickly", project_id: 2},
      ...
      {name: "Start It", description: "It's in the name!!", project_id: 4},
      {name: "Finish It", description: "You be done!", project_id: 4},
      {name: "Start It", description: "It's in the name!!", project_id: 5},
      {name: "Do It", description: "Do the thing", project_id: 5},
      {name: "Do It Again", description: "Do the thing again", project_id: 5},
